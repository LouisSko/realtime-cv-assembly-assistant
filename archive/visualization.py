...
def draw_boxed_text(img, text, topleft, color, vis_mode='detect'):
...
class BBoxVisualization():
    ...
    def draw_bboxes(self, img, boxes, confs, clss, vis_mode='detect'):
        ...
        for bb, cf, cl in zip(boxes, confs, clss):
            ...
            img = draw_boxed_text(img, txt, txt_loc, color, vis_mode)
        return img
